...
if __name__ == "__main__":
    ...
    if ref_args.dataset == "refcocog":
        ...
        temp = ""
    with open(f"./caption_llm/{args.llm_model}/{ref_args.dataset}_{ref_args.test_split}{temp}_global.json","r") as f:
        mllm_global_sentences = json.load(f)
    
    if is_add_s_l:
        with open(f"./caption_llm/{args.llm_model}/{ref_args.dataset}_{ref_args.test_split}{temp}_local.json","r") as f:
